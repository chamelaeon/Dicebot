...
public class BasicPersonality extends Personality {
	...
	public BasicPersonality(String cardPath) {
		...
		exceptionTexts.put("BrokenRegexp", "What's that? You've somehow broken regexps? Oh dear. I think you need to spend some time in the Alone Room.");
		exceptionTexts.put("ParseBadShort", "Hm. I could handle %s as a value but it would require a fundamental reordering of the universe. Hang on just an eon...");
		exceptionTexts.put("ReflectionError", "The fundamental constants of the universe seem a little off-kilter today. Better not try that again.");
		exceptionTexts.put("CannotSatisfySuccesses", "I may be clinically insane, but even I know you'll never get %d successes off %d dice.");
		exceptionTexts.put("Roll0Dice", "The sweet sounds of no dice rolling. A perfect accompaniment to the sounds of hard vacuum.");
